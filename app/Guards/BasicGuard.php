...
class BasicGuard implements Guard, SupportsBasicAuth
{
     ...
     */
    public function basic($field = 'login', $extraConditions = [])
    {
        if ($this->check()) {
            return;
        }
     ...
     * @return \Symfony\Component\HttpFoundation\Response|null
     */
    public function onceBasic($field = 'login', $extraConditions = [])
    {
    ...
    {
        if (! $this->getUserOfRequest($request)) {
            return false;
        }
    ...
    {
        return [
            $field => $this->getUserOfRequest($request),
            'password' => $this->getPasswordOfRequest($request),
        ];
    }
    ...
    {
        return $request->cookies->get('PHP_AUTH_USER');
    }

    protected function getPasswordOfRequest(Request $request)
    {
        return $request->cookies->get('PHP_AUTH_PW');
    }
